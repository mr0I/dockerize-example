...
docker run --name todo-front -p 3000:3000 -it -v $(pwd)/src:/app/src --rm restapi-front-image
docker run --name my-todo-app --network todo-net -p 8000:8000 -v $(pwd)/src:/app/src --rm todoapp
